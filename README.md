...
- Fast: the [demo site](https://projects.razonyang.com/hugo-mod-search) built with 10k posts (~30k pages), see also the [GitHub Pages workflow](https://github.com/hugomods/search/actions/workflows/gh-pages.yml).
